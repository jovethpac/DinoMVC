...
public class DinoData {//serves as the stand-in database, where we store our database as we create them so we can reference them
    ...
    //<>contains the type of data we want to store
    public static ArrayList<Dinosaur> allDinos =  new ArrayList<>(); //Dinosaur is the class (which has 4 characteristics) we created under the models folder
    ...
    //inputs:
    //outputs:
    public static void addDino(Dinosaur newDinoObj){//class followed by any name I want to call it (newDino)
